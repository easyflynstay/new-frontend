...
export function DealCard({ title, description, price, image, badge, className }: DealCardProps) {
  return (
    <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.2 }} className="cursor-default">
